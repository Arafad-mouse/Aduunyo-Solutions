...
export default function LoanApplicationPage() {
  ...
  const nextStep = async () => {
    const fields = {
      1: ['fullName', 'phoneNumber', 'emailAddress', 'referencePersonName', 'referencePersonNumber'],
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const requiredFields = [
        'fullName', 'nationalId', 'phoneNumber', 'emailAddress',
      ...
      // Age validation removed as per requirements
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input id="fullName" className="text-black" placeholder="Enter your full name" {...register('fullName')} />
                  {errors.fullName && <p className="text-red-500 text-sm">{errors.fullName.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="nationalId">National ID *</Label>
                  <Input id="nationalId" className="text-black" placeholder="Enter your national ID" {...register('nationalId')} />
                  {errors.nationalId && <p className="text-red-500 text-sm">{errors.nationalId.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="phoneNumber">Phone Number *</Label>
                  <Input id="phoneNumber" type="tel" className="text-black" placeholder="Enter your phone number" {...register('phoneNumber')} />
                  {errors.phoneNumber && <p className="text-red-500 text-sm">{errors.phoneNumber.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="emailAddress">Email Address *</Label>
                  <Input id="emailAddress" type="email" className="text-black" placeholder="Enter your email address" {...register('emailAddress')} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="referencePersonName" className="text-black" placeholder="Enter reference person's name" {...register('referencePersonName')} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="referencePersonNumber" className="text-black" placeholder="Enter reference person's phone number" {...register('referencePersonNumber')} />
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="workingPlace" className="text-black" placeholder="Enter your working place" {...register('workingPlace')} />
                  {errors.workingPlace && <p className="text-red-500 text-sm">{errors.workingPlace.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="monthlyIncome">Monthly Income *</Label>
                  <Input id="monthlyIncome" type="number" className="text-black" placeholder="Enter your monthly income" {...register('monthlyIncome')} />
                  {errors.monthlyIncome && <p className="text-red-500 text-sm">{errors.monthlyIncome.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="loanAmount">Loan Amount *</Label>
                  <Input id="loanAmount" type="number" className="text-black" placeholder="Enter desired loan amount" {...register('loanAmount')} />
                  ...
                  {uploadedFiles.length > 0 && (
                    <div className="mt-4 space-y-2">
                      ...
                      {uploadedFiles.map((file, index) => (
                        <div key={index} className="flex items-center justify-between p-2 text-sm bg-gray-50 rounded">
