...
export default function HomeClient() {
        ...
        <section className="hero"   id="hero">
          <div className="container">
            <div className="hero-content">
              <h1 style={{ textAlign: "justify", fontSize: "5rem" }}>First Loan at <br />
              <span style={{ color: "#5BA44C" }}>0%</span> Up Front</h1>
              <p style={{ textAlign: "justify" }}>At Aduunyo Solutions, we believe financial empowerment should begin without barriers. That&apos;s why your very first loan with us comes at 0% upfront cost—no hidden charges, no surprise fees.</p>
              <p style={{ textAlign: "justify" }}>Our goal is to give you access to the essential electronics you need to grow—whether it&apos;s a laptop to expand your business, a smartphone to stay connected, or household electronics to improve your daily life.</p>
              <div className="cta-block">
                <div className="relative w-[100px] h-[100px]">
                  <Image 
                    src="/landing/timmer.svg" 
                    alt="Clock icon" 
                    fill
                ...
                <h2 style={{ textAlign: "left", fontSize: "2rem" }}>Don&apos;t Wait—Own Your<br />Dream Accessory Now.</h2>
              </div>
  ...
  <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-xl shadow-sm mt-6" >
    ...
    <p style={{ textAlign: "justify", fontSize: "1rem" }}>&quot;The loan process was smooth, and the support was exceptional. Highly recommend!&quot;</p>
  </div>
  ...
  <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-xl shadow-sm">
    ...
    <p style={{ textAlign: "left", fontSize: "1rem" }}>&quot;The loan process was smooth, and the support was exceptional. Highly recommend!&quot;</p>
  </div>
    ...
    <p style={{ textAlign: "left", fontSize: "1rem" }}>&quot;The loan process was smooth, and the support was exceptional. Highly recommend!&quot;</p>
            ...
            <div className="loan-calculator-card" id="apply">
              <div className="card-header">
                <Link href="/loan" className="no-underline" style={{ textAlign: "left" }}  >
        ...
        <section className="we-accept" id="we-accept">
          <div className="container">
            ...
            <div className="payment-logos">
              ...
              <div className="logo-item">
                <div className="relative w-[100px] h-[40px] mb-2">
                  <Image 
                    src="/landing/wallet-10.svg" 
                    alt="Cash Payment" 
                    fill
                    className="object-contain"
                    sizes="100px"
              ...
              <div className="logo-item">
                <div className="relative w-[100px] h-[40px]">
                  <Image 
                    src="/landing/preimer-wallet0.svg" 
                    alt="Premier Wallet" 
                    fill
                    className="object-contain"
                    sizes="100px"
              ...
              <div className="logo-item">
                <div className="relative w-[100px] h-[40px] mb-2">
                  <Image 
                    src="/landing/assured-workload1.svg" 
                    alt="Bank Transfer" 
                    fill
                    className="object-contain"
                    sizes="100px"
          ...
          <div className="container">
            <div className="about-content">
              ...
              <div className="process-container">
                <div className="relative w-full h-auto aspect-[5/3]">
                  <Image 
                    src="/landing/application-letter.png" 
                    alt="Process Steps" 
                    fill
