                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0">
                      ...
                      />
                                    ...
                                    {errors.dateOfBirth?.message && <p className="text-red-500 text-sm">{errors.dateOfBirth.message}</p>}
                </div>
                <div className="space-y-2">
                ...
                <div className="flex items-center justify-center w-full">
                  <label htmlFor="uploadedDocument" className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                    ...
                    />
                                ...
                                {errors.uploadedDocument?.message && <p className="text-red-500 text-sm">{errors.uploadedDocument.message}</p>}
